                        # Копируем настройки из заранее подготовленного места
                        ...
                        #Установливаем атрибут исполняемого файла
                        ...
                        #Добавляем строчку в файл (TODO не работает, приходится вручную)
                        sudo sh -c "echo 'tmpfs           /var/log/scada  tmpfs   defaults,noatime,size=100m    0    0' >> /etc/fstab"
                        #Добавляем самоподписанный сертификат
